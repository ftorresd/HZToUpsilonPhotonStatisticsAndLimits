...
def saveAndRun(analysisBranch, selCategory, datacard):
	os.system("rm *.root")
	with open("outputDatacards_v01/datacard_"+analysisBranch+"_"+selCategory+".txt" , "w") as datacardFile:
		datacardFile.write(datacard)
	print datacard
	print "\n\n------------> Running Combine: combine -M Asymptotic outputDatacards_v01/datacard_"+analysisBranch+"_"+selCategory+".txt ..."
	os.system("combine -v 1 -M Asymptotic outputDatacards_v01/datacard_"+analysisBranch+"_"+selCategory+".txt > outputLimits_v01/combineOutput_Asymptotic_"+analysisBranch+"_"+selCategory+".txt")
	print "\n\n------------> Combine output:"
	os.system("cat outputLimits_v01/combineOutput_Asymptotic_"+analysisBranch+"_"+selCategory+".txt")
	print ""
	print "\n\n------------> Running Combine: combine -M HybridNew --frequentist --testStat LHC outputDatacards_v01/datacard_"+analysisBranch+"_"+selCategory+".txt -H ProfileLikelihood --fork 4"
	# os.system("                               combine -v 3 -M HybridNew --frequentist --testStat LHC outputDatacards_v01/datacard_"+analysisBranch+"_"+selCategory+".txt -H ProfileLikelihood --fork 4 > outputLimits_v01/combineOutput_HybridNew_"+analysisBranch+"_"+selCategory+".txt")
	print "\n\n------------> Combine output:"
	os.system("cat outputLimits_v01/combineOutput_HybridNew_"+analysisBranch+"_"+selCategory+".txt")
	print ""
	os.system("mkdir -p outputLimits_v01/rootFiles ; mv *.root outputLimits_v01/rootFiles/.")
...
if __name__ == "__main__":
 ...
 |___/\__,_|\__\__,_\__\__,_|_| \__,_| |_|  |_\__,_|_\_\___|_|  
																"""
	os.system("rm -rf outputDatacards_v01/*")
	os.system("rm -rf outputLimits_v01/*")
