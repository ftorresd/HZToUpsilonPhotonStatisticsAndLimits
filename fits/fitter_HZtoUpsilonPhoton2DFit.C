...
// 2D Fit
// Z Fit 
void HZToJPsiUpsilonPhotonSignalAndBackground2DFit(string analysisBranch, string selCategory) {
	setTDRStyle();
...
// DOES THE ACTUAL FITTING
  void fitter_HZtoUpsilonPhoton2DFit()  
  {
	...
	// workspace_DCBZPeakUpsilonfit2Dpsilonfit2D();
  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("JPsi", "Cat0");
  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("Upsilon", "Cat0");

  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("JPsi", "Cat1");
  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("Upsilon", "Cat1");

  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("JPsi", "Cat2");
  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("Upsilon", "Cat2");

  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("JPsi", "Cat3");
  	HZToJPsiUpsilonPhotonSignalAndBackground2DFit("Upsilon", "Cat3");
